...
return {
  formatters_by_ft = {
    ...
    jsonc = { "jq", "biome", "prettier", stop_after_first = true },
    kdl = { "kdlfmt" },
    lisp = { "lisp_fmt" },
    lua = { "stylua" },
    markdown = { "rumdl", "biome", "prettier", stop_after_first = true },
    ["markdown.mdx"] = { "rumdl", "biome", "prettier", stop_after_first = true },
    nix = { "nixfmt" },
